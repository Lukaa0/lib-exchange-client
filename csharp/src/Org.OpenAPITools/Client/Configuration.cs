...
public class Configuration : IReadableConfiguration
{
	...
	public Configuration()
	{
		...
		WebSocketUrl = "wss://ws.blockchain.info/mercury-gateway/v1/ws";
	...
	///   Initializes a new instance of the <see cref="Configuration" /> class
	/// </summary>
	public Configuration(IDictionary<string, string> defaultHeader,
		IDictionary<string, string> apiKey, IDictionary<string, string> apiKeyPrefix,
	...
	public Configuration(
		...
		ApiClient apiClient = null, IDictionary<string, string> defaultHeader = null,
		string username = null, string password = null, string accessToken = null,
		IDictionary<string, string> apiKey = null,
		IDictionary<string, string> apiKeyPrefix = null, string tempFolderPath = null,
		string dateTimeFormat = null, int timeout = 100000,
	...
	{
		get => ApiClient.RestClient.Options.MaxTimeout;
	...
	/// </summary>
	/// <returns></returns>
	public ApiClient CreateApiClient() => new(BasePath) { Configuration = this };
